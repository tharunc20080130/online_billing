...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT id, password, role FROM users WHERE username = ? AND role = 'admin'");
...
<head>
    ...
    <title>Admin Login | Billing System</title>
...
<body>
    <div class="login-card col-md-4 col-lg-3">
        <div class="card-header">
            <h3><i class="bi bi-shield-lock-fill me-2"></i>Admin Login</h3>
            <p class="small mb-0">Secure Access to Dashboard</p>
        </div>
        <div class="card-body <?php if($error) echo 'error-shake'; ?>">
            ...
            <form method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="username" class="form-control" placeholder="Enter admin username" value="admin" required>
                </div>
                <div class="mb-4">
    ...
    <script>
        // Add subtle transition effect when showing error
